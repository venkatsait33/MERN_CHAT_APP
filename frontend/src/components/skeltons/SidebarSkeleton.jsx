...
const SidebarSkeleton = () => {
    ...
    return (
        <aside className="flex flex-col w-20 h-full transition-all duration-200 border-r border-base-300 lg:w-72">
            ...
            <div className="w-full py-3 overflow-y-auto ">
                {
                    skeletonContacts.map((_, i) => (
                        <div key={i} className="flex items-center w-full gap-3 p-3">
                            {/* Avatar skeleton */}
