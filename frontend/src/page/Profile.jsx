  ...
  return (
    <div className="h-screen pt-20">
      <div className="max-w-2xl p-4 py-8 mx-auto">
        <div className="p-6 space-y-8 bg-base-200 rounded-xl">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <img src={selectedImage || authUser?.profilePic || image} alt="profile" className="object-cover border-4 rounded-full size-32 " />
